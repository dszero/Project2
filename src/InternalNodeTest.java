...
public class InternalNodeTest extends TestCase {
	...
	public void testRegionsearch()
	{
		...
		assertTrue(node.insert(20, 20, 40, 40, point1));
		assertTrue(node.insert(20, 20, 40, 40, point2));
		assertTrue(node.insert(20, 20, 40, 40, point3));		
		
		DLinkedList<Point> list = new DLinkedList<Point>();
		int visited = node.regionsearch(list, 20, 20, 40, 40, 0, 0, 20, 20);
		assertEquals(list.size(), 1);
		assertEquals(visited, 5);
		
		//----------------------------------------------
		assertNotNull(node.remove(20, 20, 40, 40, point1));
		assertNotNull(node.remove(20, 20, 40, 40, point2));
		assertNotNull(node.remove(20, 20, 40, 40, point3));
		
		Point point4 = new Point("search1", 21, 0);
		Point point5 = new Point("search2", 20, 0);
		Point point6 = new Point("search3", 0, 20);
	
		assertTrue(node.insert(20, 20, 40, 40, point4));
		assertTrue(node.insert(20, 20, 40, 40, point5));
		assertTrue(node.insert(20, 20, 40, 40, point6));	
		
		DLinkedList<Point> list1 = new DLinkedList<Point>();
		int visited1 = node.regionsearch(list1, 20, 20, 40, 40, 0, 0, 20, 20);
		assertEquals(list1.size(), 2);
		assertEquals(visited1, 5);
		
		//----------------------------------------------
		assertNotNull(node.remove(20, 20, 40, 40, point4));
		assertNotNull(node.remove(20, 20, 40, 40, point5));
		assertNotNull(node.remove(20, 20, 40, 40, point6));
		
		Point point7 = new Point("search1", 0, 21);
		Point point8 = new Point("search2", 20, 20);
		Point point9 = new Point("search3", 21, 21);
	
		assertTrue(node.insert(20, 20, 40, 40, point7));
		assertTrue(node.insert(20, 20, 40, 40, point8));
		assertTrue(node.insert(20, 20, 40, 40, point9));	
		
		DLinkedList<Point> list2 = new DLinkedList<Point>();
		int visited2 = node.regionsearch(list2, 20, 20, 40, 40, 0, 0, 20, 20);
